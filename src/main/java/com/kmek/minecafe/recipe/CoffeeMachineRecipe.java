...
public class CoffeeMachineRecipe implements Recipe<SimpleContainer> {
    ...
    public CoffeeMachineRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<CoffeeMachineRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(MineCafeMod.MODID, "coffee_machine");
        ...
        @Override
        public @Nullable CoffeeMachineRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, CoffeeMachineRecipe pRecipe) {
