...
public class CustomBaseMenu extends AbstractContainerMenu {
    public final CustomBaseBlockEntity blockEntity;
    private final Block blockToMatch;
    private final Level level;
    protected final ContainerData data;

    public CustomBaseMenu(int id, Inventory inv, CustomBaseBlockEntity entity, ContainerData data, Block blockToMatch, MenuType<?> pMenuType) {
        super(pMenuType, id);
        blockEntity = entity;
    ...
    protected void addSlots(IItemHandler handler) {
        // For child class to override and add slots to
    }
