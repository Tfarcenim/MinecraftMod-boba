...
public class WaffleIronMenu extends AbstractContainerMenu {
    public final WaffleIronBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public WaffleIronMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(WaffleIronBlockEntity.dataFieldsCount));
    }

    public WaffleIronMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.WAFFLE_IRON_MENU.get(), id);
        checkContainerSize(inv, WaffleIronBlockEntity.menuSlotCount);
        blockEntity = (WaffleIronBlockEntity) entity;
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = WaffleIronBlockEntity.menuSlotCount;  // must be the number of slots you have!
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocksInit.WAFFLE_IRON.get());
    }
