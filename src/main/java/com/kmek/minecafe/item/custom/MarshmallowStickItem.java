...
public class MarshmallowStickItem extends Item {
    private static final String tagKey = "minecafe.toastiness";
    private static final int toastinessMax = 100;
                ...
                if (targetBlock.getType() == HitResult.Type.BLOCK) {
                    ...
                    if (block instanceof CampfireBlock && pStack.hasTag()) {
                        ...
                        if (toastiness >= toastinessMax) {
                            ...
                            player.getInventory().add(pSlotId, new ItemStack(Items.DIAMOND)); // todo change item later to other marshmallow stick
                        } else {
