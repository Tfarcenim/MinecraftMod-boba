...
public class DisplayCaseMenu extends AbstractContainerMenu {
    ...
    public void add4Slots(IItemHandler handler, int startIndex, int startX, int startY) {
        for (int i = 0; i < 4; i++) {
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = DisplayCaseBlockEntity.menuSlotCount;  // must be the number of slots you have!
